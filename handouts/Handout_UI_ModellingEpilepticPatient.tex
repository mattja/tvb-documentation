...
\begin{simulation}
  ...
  \item Visualize the time series. Click on \underline{Select channels} and select all the channels. 
	You will need to increase the scaling by clicking on \includegraphics[width=0.01\textwidth]{butt_brain_menu}(Fig. \ref{fig:brain_menu}). Visualize 
	the $y_0$ (Fig. \ref{fig:first_pop}) then the $y_3$ state variable (Fig. \ref{fig:second_pop}) by 
	changing it in the \includegraphics[width=0.01\textwidth]{butt_brain_menu}. You can see a succession of 3 seizures, use the mouse
  ...
  \item Visualize the results in the \underline{Brain Viewer}, you will need to increase the rendering speed 
	(timesteps per Frame) by clicking on the \includegraphics[width=0.01\textwidth]{butt_brain_menu}.
\end{enumerate}
\end{simulation}
